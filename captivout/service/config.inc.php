...
class Config {
  ...
  public $default = [
      ...
      "vou_label" => "Code ",
      "sms_gateway" => [["label" => "Default", "locked_time" => 1440, "table" => "sms", "language" => "de", "countryPrefix" => "+41","example" => "079 123 45 67","text" => "Der code für das netz lala lautet {TICKET}","validator" => "0[0-9]{9}","httpGet" => "http://www.sms-revolution.ch/API/httpsms.php?user=test&password=pw&text={TEXT}&to={NUMBER}&action=info"]]
  ];
