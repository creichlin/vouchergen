...
<input name="test" type="submit" value="<?php echo $lang->get("sms_test"); ?>" />
<input name="send" type="submit" value="<?php echo $lang->get("sms_send"); ?>" />
<input name="block" type="submit" value="<?php echo $lang->get("sms_block"); ?>" />
</form>
<?php
