...
<head>
	...
	<title>Request wifi access code</title>
</head>

<body>
<div id="header">
	<h1 id="topic">Request wifi access code</h1>
</div>
<div id="content">
<?php
if (isset($_POST['submit'])) {
	if (is_numeric($_POST['nummer']) and is_numeric($_POST['handyvorwahl'])) {
		...
		if (verify_number($user)) {
			...
			echo "<b>You already requested a code today!</b>";
		}
	}
	else {
		echo "<b>Please enter a valid phone number without prefix!</b>";
	}
}
?>
<br />
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
<h2>Request wifi access code</h2>
Please select prefix and enter phone number: <br />
...
<a href="javascript:history.go(-2)">Back to login page</a>
</form>
</div>
</body>
